...
def get_obj(obj):
    return {
        ...
        'logo': obj.logo.url if obj.logo and obj.logo.name and obj.logo.storage.exists(obj.logo.name) else None,
        'stamp': obj.stamp.url if obj.stamp and obj.stamp.name and obj.stamp.storage.exists(obj.stamp.name) else None,
