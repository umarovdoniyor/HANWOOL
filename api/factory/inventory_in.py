...
from api.models import UserMaster, FactoryItemIn
from api.lib import Pagenation, get_excep_msg
from django.utils import timezone
from api.factory.factory_lib import get_itemin_code


class InventoryIn_Read(View):
    @transaction.atomic
    def get(self, request, *args, **kwargs):
        ...
        qs = FactoryItemIn.objects.filter(company=request_user.company).order_by('-date', '-created_at')
...
class InventoryIn_Create(View):
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            obj = FactoryItemIn.objects.create(
                code=code,
                date=date,
                desc1=desc1,
                desc2=desc2,
...
class InventoryIn_Update(View):
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            obj = get_object_or_404(FactoryItemIn, pk=int(pk))
